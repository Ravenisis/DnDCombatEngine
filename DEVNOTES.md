...
- `dist/DnDCombatEngine/DnDCombatEngine.exe` - 6,745,163 bytes
- `dist/DnDCombatEngine-1.0.3-windows.zip` - 73,343,925 bytes
- `dist/installer/DnDCombatEngine-1.0.3-Setup.exe` - 51,718,717 bytes
- `dist/msi/DnDCombatEngine-1.0.3-x64.msi` - 60,726,339 bytes
- Verified with `ruff`, `442` coverage-enforced tests at `90.35%`, mypy, a
