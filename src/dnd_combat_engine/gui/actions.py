...
def default_action_specs() -> tuple[GuiActionSpec, ...]:
    ...
    return (
        ...
        GuiActionSpec("dice.roll_d10", "Dice", "Roll d10", "Roll a ten-sided die"),
        GuiActionSpec("dice.roll_d12", "Dice", "Roll d12", "Roll a twelve-sided die"),
        GuiActionSpec("dice.roll_d20", "Dice", "Roll d20", "Roll a twenty-sided die"),
        GuiActionSpec("dice.roll_d100", "Dice", "Roll d100", "Roll percentile dice"),
        GuiActionSpec(
            "dice.repeat_last",
            "Dice",
            "Roll Previous Die",
            "Roll the most recently rolled die again",
            "Ctrl+R",
        ),
        GuiActionSpec(
            "settings.key_binds",
